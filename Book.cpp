...
void CBook::WriteData() {
	ofstream ofile;
	ofile.open("book.txt", ios::binary | ios::app);//以二进制格式(binary)打开book.dat, app:每次写操作前均定位到文件末尾
	try {
...
void CBook::DeleteData(int iCount) {//删掉第iCount条记录
	...
	file.open("book.txt", ios::binary | ios::in | ios::out);//二进制/读/写
	tmpfile.open("temp.txt", ios::binary | ios::out | ios::in | ios::trunc);
